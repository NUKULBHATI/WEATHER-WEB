...
function App() {
  ...
  return (
    <>
      <div style={{ backgroundImage: "url(green-field-with-sunny-day.jpg)" }} className="justify-center items-center h-screen w-screen space-y-4 p-4 bg-blue-200 bg-no-repeat bg-cover bg-center">
        ...
        <div className="weather-data mt-4 w-full flex justify-center items-center">
          {
            weather_data && (
              <div style={{ backgroundImage: "url(Field-yellow-flowers-with-hills-cloudy-sky.jpg)" }} className="mt-4 text-center grid gap-6 bg-white bg-opacity-70 p-6 rounded-lg shadow-lg w-full h-full border-4 border-black 
